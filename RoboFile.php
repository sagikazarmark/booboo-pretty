...
class RoboFile extends \Robo\Tasks
{
    ...
    public function assets()
    {
        $this->taskFileSystemStack()
            ...
            ->copy(__DIR__.'/vendor/zeroclipboard/zeroclipboard/dist/ZeroClipboard.min.js', __DIR__.'/resources/assets/js/ZeroClipboard.min.js', true)
            ->copy(__DIR__.'/vendor/zeroclipboard/zeroclipboard/dist/ZeroClipboard.swf', __DIR__.'/resources/assets/js/ZeroClipboard.swf', true)
            ->run();
